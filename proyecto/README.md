...
│
├── taller2/
│   └── README.md                   ← informe de Taller 2
│
└── taller3/
    ├── taller-instrucciones.md     ← rúbrica oficial
    ├── result-pendings.md          ← bitácora
    └── infodata.md                 ← credenciales locales (gitignored)
```
...
| Ver la rúbrica oficial | [`../taller3/taller-instrucciones.md`](../taller3/taller-instrucciones.md) |
| Ver el informe del Taller 2 | [`../taller2/README.md`](../taller2/README.md) |
